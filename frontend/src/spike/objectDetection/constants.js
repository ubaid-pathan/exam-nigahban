// Milestone 2 AI spike only -- isolated from frontend/src/monitoring/, which
// remains completely unmodified. Nothing here is wired into the production
// exam-monitoring workflow.
//
